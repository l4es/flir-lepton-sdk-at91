...
CFG_LIB=
CFG_OBJ=
COMMON_OBJ=$(OUTDIR)/sama5d2_I2C.o $(OUTDIR)/crc16fast.o \
...
ALL_OBJ=$(OUTDIR)/sama5d2_I2C.o $(OUTDIR)/crc16fast.o \
	$(OUTDIR)/LEPTON_AGC.o $(OUTDIR)/LEPTON_VID.o \
	$(OUTDIR)/LEPTON_I2C_Protocol.o $(OUTDIR)/LEPTON_I2C_Service.o \
	$(OUTDIR)/LEPTON_SDK.o $(OUTDIR)/LEPTON_SYS.o $(OUTDIR)/LEPTON_OEM.o

COMPILE=$(CC) -fpermissive -Dlinux=1 -c  -v  -g -o "$(OUTDIR)/$(*F).o" $(CFG_INC) "$<"
